...
var EmojiAvatar = ({ address, ensImage, size }) => {
  ...
  const { color: backgroundColor, emoji } = useMemo2(
...
function Dialog({ children, onClose, open, titleId }) {
  ...
  return /* @__PURE__ */ React15.createElement(React15.Fragment, null, open ? createPortal(
    /* @__PURE__ */ React15.createElement(RemoveScroll, null, /* @__PURE__ */ React15.createElement(Box, {
      ...themeRootProps
...
// src/components/MenuButton/MenuButton.tsx
var MenuButton = React32.forwardRef(
  ({ children, currentlySelected = false, onClick, ...urlProps }, ref) => {
    const mobile = isMobile();
...
function DownloadDetail({
  ...
  return /* @__PURE__ */ React43.createElement(Box, {
    ...
    onClick: () => changeWalletStep(
      (qrCode == null ? void 0 : qrCode.instructions) ? "INSTRUCTIONS" /* Instructions */ : "CONNECT" /* Connect */
    )
  })));
}
var stepIcons = {
...
function DesktopOptions({ onClose }) {
  ...
  const [initialWalletStep, setInitialWalletStep] = useState8(
    "NONE" /* None */
  );
  ...
  return /* @__PURE__ */ React44.createElement(Box, {
    ...
    ([groupName, wallets2], index) => wallets2.length > 0 && /* @__PURE__ */ React44.createElement(Fragment2, {
      key: index
...
function MobileOptions({ onClose }) {
  ...
  let headerBackButtonLink = null;
  const [walletStep, setWalletStep] = useState9(
    "CONNECT" /* Connect */
  );
  const ios = isIOS();
  switch (walletStep) {
...
function ConnectButton({
  ...
  return /* @__PURE__ */ React50.createElement(ConnectButtonRenderer, null, ({
    ...
    if (allowList[0] == "") {
      ...
      const allowedCheck = allowList.filter((address) => (account == null ? void 0 : account.address) == address);
      if (allowedCheck == []) {
        allowed = false;
      } else {
        allowed = true;
    ...
    if (blockList[0] == "") {
      ...
      const blockedCheck = blockList.filter((address) => (account == null ? void 0 : account.address) == address);
      if (blockedCheck == []) {
        allowed = true;
      } else {
        allowed = false;
    ...
    return /* @__PURE__ */ React50.createElement(Box, {
    ...
    }, mounted && account ? /* @__PURE__ */ React50.createElement(React50.Fragment, null, allowList && (allowList.length >= 1 || !allowed) && /* @__PURE__ */ React50.createElement(Box, {
      alignItems: "center",
      as: "button",
      background: !allowed ? "connectButtonBackgroundError" : "connectButtonBackground",
      ...
      color: !allowed ? "connectButtonTextError" : "connectButtonText",
      ...
      fontWeight: "bold",
      gap: "6",
      key: !allowed ? "unsupported" : "supported",
      onClick: openChainModal,
      paddingX: "10",
      paddingY: "8",
      transition: "default",
      type: "button"
    }, !allowed ? /* @__PURE__ */ React50.createElement(Box, {
      alignItems: "center",
      display: "flex",
      height: "24",
      paddingX: "4"
    }, "Not Allowed") : /* @__PURE__ */ React50.createElement(Box, {
      alignItems: "center",
      display: "flex",
      gap: "6"
    }), /* @__PURE__ */ React50.createElement(DropdownIcon, null)), chain2 && (chains.length > 1 || unsupportedChain) && /* @__PURE__ */ React50.createElement(Box, {
      alignItems: "center",
      as: "button",
